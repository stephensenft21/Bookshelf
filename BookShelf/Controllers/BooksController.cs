...
namespace BookShelf.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task <IActionResult> Create()
        {
            ...
            var authors = _context.Authors.Where(a => a.ApplicationUserId == user.Id);
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,Title,AuthorId,Genre,YearPublished,Rating")] Book book)
        {
            var user = await GetCurrentUserAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,Title,AuthorId,Genre,YearPublished,Rating,ApplicationUserId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
